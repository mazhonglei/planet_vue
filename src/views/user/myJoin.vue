<template>
    <transition :name="transitionName">
        <div class="body" id="myJoin">
            <div class="new">
                <!--头部-->
                <div class="header">
                    <div class="immersion">
                         <span class="backImg" @click="changeRoute('/myInfo',{'from':'myJoin'})">
                            <img src="@/assets/img/ic_back.png" alt="">
                        </span>
                        <span class="titlefont">我加入的班级</span>
        ...
        mounted() {
            ...
            mui.back = function () {
                ...
                if (!first) {
                    ...
                    that.changeRoute('/myInfo',{'from':'myJoin'})
            ...
            routeClass: function (groupId) {
                ...
                axios.post(url, info).then(function (response) {
                    if (response.data.is_member == 1) {
                        that.changeRoute('/classIndex', {groupId: groupId, from: 'myJoin'})
                    } else {
                        that.msg = "无法进入班级";
                    }
                }).catch(function (error) {
