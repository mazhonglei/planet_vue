            ...
            <div class="news">
                <div class="header">
                    <div class="immersion">
                        ...
                        <span class="titlefont">忘记密码</span>
                    </div>
                </div>
                <div class="phone">
                    <span class="phone-text">手机号</span> <input type="text" v-model="account" placeholder="输入手机号码">
                ...
                <div class="pass">
                    <span>新密码</span> <input :type="this.login_data.pwdType" v-model="pwd" placeholder="输入6位以上登录密码">
        ...
        methods: {
            ...
            routeForgot: function () {
                ...
                let info = {
                    ...
                    password: password,
                    phoneCode: phoneCode,
                    accessToken: sha1(username + password + phoneCode + apiKey)
                };
                let url = site + '/api/users/forgotPwd';
                let that = this;
