<template>
    <transition :name="transitionName">
        <div class="body" id="changePwd">
            <div class="news">
                <div class="header">
                    <div class="immersion">
                        <span class="backImg" @click="changeRoute('/set',{'from':'changeTradePwd'})">
                                <img src="@/assets/img/ic_back.png" alt="">
                            </span>
                        <span class="titlefont">修改支付密码</span>
                    </div>
                </div>
                <div class="pass">
                    <span>原支付密码</span> <input :type="this.login_data.pwdType" v-model="oldPwd" placeholder="输入6位以上登录密码">
                ...
                <div class="pass">
                    <span>新支付密码</span> <input :type="this.login_data.pwdType2" v-model="newPwd" placeholder="输入6位以上登录密码">
        ...
        mounted(){
            ...
            mui.back = function () {
                ...
                if (!first) {
                    ...
                    that.changeRoute('/set',{'from':'changeTradePwd'})
        ...
        eyeShow(){
            ...
            routeForgot: function () {
                ...
                let info = {
                    ...
                    type:type,
                    accessToken: sha1(uid + username + oldPassword + newPassword + type + apiKey)
                };
...
<style lang="scss">
    @import "../../assets/css/login/changePwd.scss";
