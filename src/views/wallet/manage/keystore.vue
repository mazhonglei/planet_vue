        ...
        <div class="export-box">
            <div class="header">
                <div class="immersion">
                    ...
                    <span class="titlefont">导出 keystore</span>
                </div>
            </div>
            <div class="mg-44">
                <div class="private-nav">
                    <div class="" :class="tab==1?'export-active':''" @click="tab=1">Keystore</div>
                    ...
                    <div id="item1" class="mui-slider-item mui-control-content" :class="tab==1?'mui-active':''" v-show="tab==1">
                        ...
                        <div class="text-box">
                            ...
                            <button
                                    ...
                                    v-clipboard:error="" id="alert_little">复制 keystore</button>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        created() {
            this.aAlert_shot({
                show: true,
                tip: "如果有人获取你的Keystore 将有可能获取你的资产！请妥善保管 Keystore。",
            });
        },
        mounted() {
            let that = this;
